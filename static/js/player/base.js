...
class Player extends AcGameObject {
    ...
    constructor(root, info) {
        ...
        this.direction = 1;//正方向定义成1、反方向是-1
        ...
        this.status = 3; // 0:idle[站原地]，1:向前，2:向后，3:跳跃，4:攻击，5:被打，6:死亡
        this.animations = new Map();
        this.frame_current_cnt = 0; //表示当前记录了多少帧 表示帧的编号
    ...
    render() {
        ...
        if (obj && obj.loaded) {
            if (this.direction > 0) {
                ...
                this.ctx.save(); //先保存配置
                this.ctx.scale(-1, 1); //scale可以让整个图乘系数 表示x乘-1 y不变
                this.ctx.translate(-this.root.game_map.$canvas.width(), 0); //平移
        ...
        this.frame_current_cnt++;//相当于一秒钟显示60帧，太快了，要设置rate
    }
}
